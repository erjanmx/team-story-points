...
class Main extends Component {
  ...
  handleFormSubmit(e) {
    ...
    const channelUuid = 3385;//e.target.elements.channelUuid.value.trim();
          ...
          <div className="columns">
            <div className="column">
              <div className="control">
                ...
                <input type="text" className="input" name="memberName" placeholder="Channel ID" autoComplete="off" />
              </div>
            </div>
            <div className="column">
              <div className="control">
